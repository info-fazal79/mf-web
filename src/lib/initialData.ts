...
export const INITIAL_SITE_SETTINGS: SiteSettings = {
  ...
  maintenance_title: 'Upgrading System & Infrastructure',
  maintenance_message: 'We are currently deploying new features and performance enhancements. We will be back online shortly.',
  logo_type: 'text',
  logo_text: 'FAZAL',
  logo_width: 130,
