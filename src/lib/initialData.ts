...
export const TESTIMONIALS = [
  ...
  {
    name: 'Rebecca Moore',
    role: 'Operations Director, Nexa Consulting (USA)',
    avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=200&auto=format&fit=crop',
    rating: 5,
    text: 'Fazal created an automated Google Sheets and Apps Script system that saved our team at least 15 hours every single week. Truly a master at data automation!',
  },
  {
    ...
    rating: 5,
    text: 'As Lead Instructor, Muhammad Fazal has trained hundreds of students with patience, deep technical knowledge, and an inspiring teaching methodology.',
  },
];
